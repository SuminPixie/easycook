...
<head>
  ...
  <!-- 자바스크립트 쿠키파일 연결 -->
  <script defer src="./script/javascript_cookie.js"></script>
...
<body>
  ...
  <main>
    <section id="Login">
      <h2>로그인</h2>
      <form action="./act/login_check.php" id="loginForm" name="loginForm" method="post">
...
<script>
  Kakao.init('4ee70829e487a3d51af14c0335fdbe22');
        ...
        Kakao.API.request({ url: '/v2/user/me' })
          .then(function(res){
            const payload = {
              ...
              avatar: res.kakao_account?.profile?.profile_image_url || '',
